...
def oyo():
    ...
    dat=json.dumps({"phone":c,"country_code":"+88","country_iso_code":"ID","nod":"4","send_otp":"true","devise_role":"Consumer_Guest"})
...
if __name__=="__main__":
     try:
          ...
          baner()
          hh="+88"
          no=input("[+]Nabil Say Enter Number: ")
          c=no[1:12]
          w=hh+c 
          kata("NABIL SAY WAIT")
          jenius()
